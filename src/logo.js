...
export default function Logo() {
  return (
<svg className='pathWrapper' version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="60px" height="60px" viewBox="0 0 200.000000 200.000000"
 preserveAspectRatio="xMidYMid meet">

<g transform="translate(0.000000,200.000000) scale(0.100000,-0.100000)"
fill="#000000" stroke="none">
<path fill='#ff2300' className='path1' d="M890 1791 c-60 -20 -136 -66 -182 -112 -55 -55 -108 -158 -115 -222
...
<path fill='#e4a832' className='path2' d="M454 1362 c-112 -39 -194 -111 -251 -222 -26 -51 -28 -63 -28 -175 0
...
<path fill='#0b024e' className='path3' d="M1361 1297 l-83 -84 34 -27 c26 -19 47 -26 80 -26 90 0 167 -45 199
...
<path fill='#ff2300' className='path4' d="M656 601 l-78 -78 11 -52 c26 -123 116 -240 229 -297 54 -27 64 -29
